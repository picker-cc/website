...
<script lang="ts">
  ...
  export default class Navbar extends Vue {
    ...
    //   super();
      // console.log(this);
      // this.$options.el = this.$options[0];
    // }
    private linksWrapMaxWidth: number = null;
    ...
    public mounted(): void {
      ...
      const handleLinksWrapWidth = () => {
        if (document.documentElement.clientWidth < MOBILE_DESKTOP_BREAKPOINT) {
          ...
          // const el:HTMLElement = <HTMLElement>this.$el
          this.linksWrapMaxWidth = (this.$el as HTMLElement).offsetWidth - NAVBAR_VERTICAL_PADDING
            - (this.$refs.siteName && (this.$refs.siteName as HTMLElement).offsetWidth || 0)
        }
      }
    ...
    public css(el: Element, property: any) {
